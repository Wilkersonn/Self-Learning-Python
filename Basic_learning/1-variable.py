...
# -----------------------------------------------------
# Fonction seen        ➔ Print() - Display
#                      ➔ input() - Read keyboard
#                      ➔ type() - return type of data, variable, etc.
#                      ➔ int() - str(), float(), bool() : Cast a data
#                      ➔ str.format() - Format a chains
...
# Exemple to convert a str var to an int var
priceHT = input("Type your price : ")

priceHT =int(priceHT)

priceTTC = priceHT + (priceHT * 20 / 100)
print("Price TTC =", priceTTC)

# Exemple to convert boolean to int (true = 1, false = 0)
boolean = True
boolean = int(boolean)
